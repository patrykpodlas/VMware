...
function Get-QESXiSecurity {
    ...
    .EXAMPLE
        PS C:\> Get-QESXiSecurity -Settings -Services
    ...
    process {
        if ($Settings) {
            ...
            $ESXiSettings = @{
                ...
                #"Config.HostAgent.plugins.hostsvc.esxAdminsGroup" = "core\gacp004"
...
>>>>>>> 2a76f316d70ccc3f7e7ebf9c5c5742f68aff5886
}